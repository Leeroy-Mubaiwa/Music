...
namespace Music.Controllers
{
    ...
    public class AlbumsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ArtistId,ReleaseDate")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ArtistId,ReleaseDate")] Album album)
        {
            if (id != album.Id)
            {
                return NotFound();
